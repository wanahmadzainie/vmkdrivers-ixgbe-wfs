...
/**
 * \brief Structure used by VMK_PORTSET_QUERY_PFLIST.
 *
...
/**
 * \brief Uplink features advertised by a port.
 *
 *  A port's uplink feature is used by load balancer to decide on what
 *  type of rx queue to allocate. This uplink feature is to be
 *  advertised only for non-uplink ports.
 */
typedef enum vmk_PortUplinkFeatures {

    /** No feature */
    VMK_PORT_UPLINK_FEAT_NONE     = 0x0,

    /** HW LRO feature */
    VMK_PORT_UPLINK_FEAT_LRO      = 0x1,

    /** reserved */
    VMK_PORT_UPLINK_FEAT_RESERVED = 0x2,

    /** RSS feature */
    VMK_PORT_UPLINK_FEAT_RSS      = 0x4,
} vmk_PortUplinkFeatures;
