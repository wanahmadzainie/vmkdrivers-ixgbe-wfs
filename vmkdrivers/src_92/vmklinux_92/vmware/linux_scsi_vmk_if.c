 ...
 *----------------------------------------------------------------------
 *
 * SCSILinuxDummyDumpBH --
 *
 *      This is a no-op function.
 *
 *      This BH handler is provided here to satisfy vmk_ScsiAdapter
 *      which requires a real function for the entry point 'dumpBHHandler'.
 *      Since each driver registers its own dump completion routine,
 *      the dumpBHHandler callback is no longer needed. For binary
 *      compatibility reason, dumpBHHandler is being kept.
 *
 * Results:
 *      VMK_OK
 *
 ...
 */
void
SCSILinuxDummyDumpBH(void *clientData)
{
   return;
}
