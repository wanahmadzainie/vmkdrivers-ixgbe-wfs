/* *****************************************************************
 * Portions Copyright 1998, 2011 VMware, Inc.
 *
...
typedef struct vmklnx_ScsiAdapterVectorInfo {
   vmk_uint32 vector;
   void *intTracker;
   spinlock_t lock;
...
struct vmklnx_ScsiAdapter {
   ...
   spinlock_t lock;
   volatile unsigned long numVec;
   struct vmklnx_ScsiAdapterVectorInfo *vector_info;
};
