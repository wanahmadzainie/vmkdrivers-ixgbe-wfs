...
bool lpfc_is_mapped_node_logged_in(struct lpfc_vport *, uint32_t);
...
{
	return (phba->hba_flag & HBA_FCOE_MODE) ? true : false;
}
...
{
	return (phba->hba_flag & HBA_FCOE_MODE) ? false : true;
}
...
struct lpfc_node_rrq *lpfc_get_active_rrq(struct lpfc_vport *, uint16_t,
	uint32_t);
uint32_t lpfc_port_link_speed(struct lpfc_hba *);
struct Scsi_Host *lpfc_diag_shost_alloc(void);
void lpfc_discovery_wait(struct lpfc_vport *);
int lpfc_ioctl_hba_adapterattributes(struct lpfc_hba *, struct lpfcCmdInput *,
				void *);
int lpfc_ioctl_hba_portstatistics(struct lpfc_hba *, struct lpfcCmdInput *,
				void *);
int lpfc_ioctl_node_stat(struct lpfc_hba *, struct lpfcCmdInput *, void *, int);

int lpfc_proc_page_selector(char *);
int lpfc_proc_default(struct Scsi_Host *, char *, int);
int lpfc_proc_ptxcnt(struct Scsi_Host *, char *, int);
int lpfc_proc_hbaattr(struct Scsi_Host *, char *, int);
int lpfc_proc_adapterportstats(struct Scsi_Host *, char *, int);
int lpfc_proc_targetportstats(struct Scsi_Host *, char *, int);
int lpfc_ioctl_nodeinfo(struct lpfc_hba *, struct lpfcCmdInput *,
			void *, int);
int lpfc_proc_getcfg(struct Scsi_Host *, char *, int);

int lpfc_ioctl_hba_portattributes(struct lpfc_hba *,
				  struct lpfcCmdInput *, void *);
int lpfc_ioctl_send_scsi_fcp(struct lpfc_hba *, struct lpfcCmdInput *);
int lpfc_ioctl_vport_list(struct lpfc_hba *, struct lpfcCmdInput *, void *);
int lpfc_ioctl_vport_nodeinfo(struct lpfc_hba *, struct lpfcCmdInput *, void *);

int lpfc_proc_page_selector(char *);
int lpfc_proc_default(struct Scsi_Host *, char *, int);
int lpfc_proc_ptxcnt(struct Scsi_Host *, char *, int);
int lpfc_proc_pagecount(struct Scsi_Host *, char *, int);
void lpfc_resetcounters(struct lpfc_hba *);
int lpfc_proc_saninfo(struct Scsi_Host *, char *, int);
int lpfc_proc_vsaninfo(struct Scsi_Host *, char *, int);
int lpfc_mgmt_issue_sli_cfg_ext_mbox(struct lpfc_hba *phba,
				 struct lpfc_sysfs_mbox *sysfs_mbox);

void lpfc_sli4_stop_chip(struct lpfc_hba *);
void lpfc_dump_wq(struct lpfc_hba *, struct lpfc_queue *);
void lpfc_dump_cq(struct lpfc_hba *, struct lpfc_queue *);
void lpfc_dump_fcp_wq(struct lpfc_hba *);
void lpfc_dump_fcp_cq(struct lpfc_hba *);
void lpfc_dump_mbox_queue(struct lpfc_hba *);
ssize_t lpfc_sli4_pdev_reg_request(struct lpfc_hba *, uint32_t);
