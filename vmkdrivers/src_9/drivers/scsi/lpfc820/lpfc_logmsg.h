...
#define LOG_DAEMON	0x00020000	/* GET,SET,UNSET logging */
#define LOG_FIP		0x00040000	/* FIP events */
#define LOG_PROC	0x00080000	/* Proc Node verbose */
#define LOG_FCP_UNDER	0x00100000	/* FCP underruns errors */
#define LOG_TRC_NODE	0x00200000	/* Node Tracing (DEBUG_FS) */
