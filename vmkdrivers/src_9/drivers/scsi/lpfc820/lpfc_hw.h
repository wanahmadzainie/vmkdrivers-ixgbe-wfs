...
#define AliasServer_DID 0xfffff8U
#define FDMI_DID        0xfffffaU
#define TimeServer_DID  0xfffffbU
...
#define SLI2_IOCB_CMD_R0_ENTRIES    460	/* SLI-2 FCP command ring entries */
#define SLI2_IOCB_RSP_R0_ENTRIES    436	/* SLI-2 FCP response ring entries */
...
#define SLI2_IOCB_CMD_R2_ENTRIES     32	/* SLI-2 ELS command ring entries */
#define SLI2_IOCB_RSP_R2_ENTRIES     32	/* SLI-2 ELS response ring entries */
...
/* 1113 IOCBs fit into 128KB SLIM Size.
 * Calculation accounts for 256 (MAILBOX_t) + 512 mailbox extension +
 * 140 (PCB_t) + 556 IOCB Commands at 128 bytes + 556 responses
 * at 64 bytes.   This layout consumes about 110,000 of the 131072 bytes.
 */
#define SLI2_SLIM_SIZE   (128 * 1024)

/* Maximum IOCBs that will fit in SLI2 slim */
#define MAX_SLI2_IOCB    1113
...
struct lpfc_sli2_slim {
	...
	PCB_t pcb;
	uint8_t iocb_buffer[MAX_SLIM_IOCB_SIZE];
};
