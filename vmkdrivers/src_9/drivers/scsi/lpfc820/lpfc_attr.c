...
lpfc_sli4_pdev_status_reg_wait(struct lpfc_hba *phba)
{
	...
	/* to slience compiler warning */
	portstat_reg.word0 = 0;
...
*/
LPFC_ATTR(link_speed, 0, 0, LPFC_USER_LINK_SPEED_MAX,
	CFG_EXPORT | CFG_THIS_HBA | CFG_FC, CFG_REBOOT,
	"link_speed",
	"Select link speed: valid values are 1, 2, 4, 8, 16",
...
LPFC_ATTR_R(fcf_failover_policy, 1, 1, 2,
	CFG_EXPORT | CFG_COMMON | CFG_THIS_HBA | CFG_FCOE, CFG_REBOOT,
	"fcf_failover_policy",
...
#
# Value range is [1,31]. Default value is 8.
*/
...
/*
# lpfc_enable_rrq: Enable RRQ functionality
# Value range is [0,1].  Default is 0 (disabled).
*/
LPFC_ATTR_R(enable_rrq, 0, 0, 1,
	    CFG_EXPORT | CFG_COMMON | CFG_THIS_HBA, CFG_REBOOT,
	    "enable_rrq",
