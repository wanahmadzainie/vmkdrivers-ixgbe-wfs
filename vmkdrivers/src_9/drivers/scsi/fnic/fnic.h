...
#if defined(__VMKLNX__)
irqreturn_t fnic_isr_legacy(int irq, void *data);
irqreturn_t fnic_isr_msi(int irq, void *data);
irqreturn_t fnic_isr_msix_poll(int irq, void *data);
