...
#define INT_CC_DIAG_MODE		EXT_CC_RESERVED0S_OS
#define INT_CC_GET_BOARD_TEMP		EXT_CC_RESERVED0T_OS
#define INT_CC_FRU_VPD_OP		EXT_CC_RESERVED0U_OS
#define INT_CC_GET_SERDES_PARAMS	EXT_CC_RESERVED0V_OS
#define INT_CC_HOST_SIDE_QOS		EXT_CC_RESERVED0W_OS
#define INT_CC_GET_VPORT_LIST		EXT_CC_RESERVED0X_OS
...
/* FRU VPD subcommands */
#define	INT_SC_SET_FRU_VPD		1
#define	INT_SC_READ_FRU_STATUS		2
#define	INT_SC_WRITE_FRU_STATUS		3
...
/* 82XX IOCTL reset SubCodes */
#define INT_SC_RESET_FCoE_CTX 0x03

/* Build ID strings */
#define BUILD_ID_FW	"QLFCFW"
#define BUILD_ID_BIOS	"QLFCBIOS"
#define BUILD_ID_EFI	"QLFCEFI"
#define BUILD_ID_FCODE	"QLFCFCODE"
#define BUILD_ID_CNA	"QLMBOOT"

/* Offsets */
#define OFFSET_QLMBOOT		0x06
#define OFFSET_QLFC_FW		0x06
#define OFFSET_QLFCEFI		0x2A
#define OFFSET_QLFCBIOS		0x4E
#define OFFSET_QLFCFCODE	0x72

/* Device Address */
#define DEV_ADDR_FRU	0xA0
#define DEV_ADDR_STATUS	0xE0

/* Options */
#define UPDATE_FRU_VPD		BIT_13
#define MULTI_BYTE_WRITE	BIT_0
...
struct qla_image_version_list {
	UINT32	count;
	struct	qla_image_version	version[0];	/* Variable length */
} __attribute__ ((packed));
