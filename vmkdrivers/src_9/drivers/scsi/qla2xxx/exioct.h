...
#define	EXT_SC_GET_DCBX_PARAM		11
...
/* Sub Codes for FCP_PRIO_CFG (FCP priority configuration) command */
#define INT_SC_FCP_PRIO_DISABLE		0x00
#define INT_SC_FCP_PRIO_ENABLE		0x01
#define INT_SC_FCP_PRIO_GET_CONFIG	0x02
#define INT_SC_FCP_PRIO_SET_CONFIG	0x03

/* Sub Codes for INT_CC_HOST_SIDE_QOS command */
#define INT_SC_HOST_SIDE_QOS_COMP_REG	0x00
#define INT_SC_HOST_SIDE_QOS_GET_CAP	0x01
#define INT_SC_HOST_SIDE_QOS_SET	0x02
#define INT_SC_HOST_SIDE_QOS_GET	0x03
#define INT_SC_HOST_SIDE_QOS_ENABLE	0x04
#define INT_SC_HOST_SIDE_QOS_DISABLE	0x05
#define INT_SC_HOST_SIDE_QOS_GET_PERF	0x06
#define INT_SC_HOST_SIDE_QOS_TUNE_SLO	0x07

/* SLO types for Host Side QoS */
#define QL_HOST_SIDE_QOS_MAX_SLO_TYPES	3
#define QL_HOST_SIDE_QOS_TYPE_LATENCY	1
#define QL_HOST_SIDE_QOS_TYPE_BW	2
#define QL_HOST_SIDE_QOS_TYPE THRUPUT	3

/* Capability parameters for Host Side QoS */
#define QL_HOST_SIDE_QOS_UNDEFINED	0
#define QL_HOST_SIDE_QOS_CAP_QUANT_BW_ONLY	1



/* Sub Codes for (82XX QUIESCENT mode configuration) command */
#define INT_SC_RESET_DIAG_MODE	0
#define INT_SC_SET_DIAG_MODE	1
...
/* This structure should always be in sync with CNAPORTPROPERTY structure */
...
typedef struct _EXT_REGIONVERSION {
	UINT16 	Region;
	UINT16 	SubRegion; 	/* If all boot codes are using region 0x7 */
...
typedef struct _EXT_HOST_SIDE_QOS_PROP {
	UINT8	Signature[4];
	UINT16	Version;
	UINT16	ErrorCode;
	UINT16	CompType;
	...
	UINT16	DeviceId;
	UINT16  Reserved[4];
} EXT_HOST_SIDE_QOS_PROP, *PEXT_HOST_SIDE_QOS_PROP;

typedef struct _EXT_HOST_SIDE_QOS_CAP {
	UINT8	Signature[4];
	UINT16	Version;
	UINT16	ErrorCode;
	UINT16	NumOfVps;
	...
	UINT16  Cap[16];
	UINT16	Reserved[4];
} EXT_HOST_SIDE_QOS_CAP, *PEXT_HOST_SIDE_QOS_CAP;

typedef struct _EXT_HOST_SIDE_QOS_PARAM {
	UINT8	Signature[4];
	UINT16	Version;
	UINT16	ErrorCode;
	UINT8	WWPN[8];
	...
	UINT16	SloValue;
	UINT16	Reserved[4];
} EXT_HOST_SIDE_QOS_PARAM, *PEXT_HOST_SIDE_QOS_PARAM;

typedef struct _EXT_HOST_SIDE_QOS_PERF {
	UINT8	Signature[4];
	UINT16	Version;
	UINT16	ErrorCode;
	UINT8	WWPN[8];
	...
	UINT16	Reserved[4];
} EXT_HOST_SIDE_QOS_PERF, *PEXT_HOST_SIDE_QOS_PERF;

typedef struct _EXT_VPORT_ENTRY {
	UINT8	WWPN[8];
	UINT8	WWNN[8];
	UINT16	Reserved[8];
} EXT_VPORT_ENTRY, *PEXT_VPORT_ENTRY;

typedef struct _EXT_VPORT_LIST {
	UINT8	Signature[4];
	UINT16	Version;
	UINT16	NumOfEntries;
	EXT_VPORT_ENTRY	VP[1];
} EXT_VPORT_LIST, *PEXT_VPORT_LIST;
