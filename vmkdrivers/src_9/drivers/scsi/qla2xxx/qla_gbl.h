...
extern int qla2xxx_perform_loop_resync(scsi_qla_host_t *);
...
extern void qla82xx_fcoe_ctx_reset_cleanup(scsi_qla_host_t *, int);
...
extern int qla82xx_alloc_fw_minidump(scsi_qla_host_t *);
extern void qla2x00_try_to_stop_firmware(scsi_qla_host_t *);
extern void qla84xx_put_chip(struct scsi_qla_host *);

extern int qla82xx_fcoe_ctx_reset(scsi_qla_host_t *, int);
...
extern int qla2x00_eh_wait_for_all_pending_commands(scsi_qla_host_t *, int);
extern int qla82xx_check_fw_alive(scsi_qla_host_t *);
...
extern int
qla2x00_set_params_mbx(scsi_qla_host_t *, dma_addr_t, size_t, uint16_t *,
	uint16_t);
...
extern int
qla2x00_get_params_mbx(scsi_qla_host_t *, dma_addr_t , size_t, uint16_t *,
	uint16_t);
...
extern int
qla2xxx_read_serdes_word(scsi_qla_host_t *, uint16_t, uint16_t *);
...
extern int
qla82xx_req_template_size(scsi_qla_host_t *);
extern int
qla82xx_get_minidump_template(scsi_qla_host_t *, dma_addr_t);
...
extern int
qla8xxx_get_xgmac_stats(scsi_qla_host_t *, dma_addr_t, uint16_t);
extern int
qla8xxx_get_dcbx_params(scsi_qla_host_t *, dma_addr_t, uint16_t);
extern int
qla2x00_read_ram_word(scsi_qla_host_t *, uint32_t, uint32_t *);
extern int
qla2x00_write_ram_word(scsi_qla_host_t *, uint32_t, uint32_t);
extern int qla81xx_get_port_config(scsi_qla_host_t *, uint16_t *);
extern int qla81xx_set_port_config(scsi_qla_host_t *, uint16_t *);
extern int qla82xx_collect_md_data(scsi_qla_host_t *, int);
...
extern int
qla25xx_read_serdes_params(scsi_qla_host_t *, serdes_params_t *);
...
extern int qla2xxx_flash_npiv_conf(scsi_qla_host_t *, uint8_t);
extern void qla2xxx_npiv_cleanup(scsi_qla_host_t *);
extern int qla82xx_config_led(scsi_qla_host_t *, uint16_t);
/*
...
extern void qla82xx_collect_fw_dump(scsi_qla_host_t *, int);
...
extern void qla82xx_update_fw_options(struct scsi_qla_host *);
extern int qla82xx_check_hw_init(struct scsi_qla_host *, int);
extern int qla82xx_pinit_from_rom(struct scsi_qla_host *, int);
extern int qla82xx_load_from_blob(struct qla_hw_data *);
extern void qla82xx_watchdog(scsi_qla_host_t *);

/* Firmware and flash related functions */
extern int ql82xx_rom_lock_d(struct qla_hw_data *);
extern int qla82xx_read_status_reg(struct qla_hw_data *, uint32_t *);
extern int qla82xx_write_status_reg(struct qla_hw_data *, uint32_t);
extern int qla82xx_flash_set_write_enable(struct qla_hw_data *);
extern int qla82xx_write_disable_flash(struct qla_hw_data *);
extern int qla82xx_wait_rom_done(struct qla_hw_data *);
extern int qla82xx_flash_wait_write_finish(struct qla_hw_data *);
extern void qla82xx_update_fw_options(struct scsi_qla_host *);
extern int qla82xx_load_risc(scsi_qla_host_t *, uint32_t *);
extern void qla82xx_update_fw_options(struct scsi_qla_host *);
extern int qla82xx_beacon_on(struct scsi_qla_host *);
extern int qla82xx_beacon_off(struct scsi_qla_host *);
extern void qla82xx_beacon_blink(struct scsi_qla_host *);
...
extern int qla82xx_unprotect_sector(scsi_qla_host_t *, int);
extern int qla82xx_protect_sector(scsi_qla_host_t *, int);
...
extern int qla82xx_abort_command(scsi_qla_host_t *, srb_t *);
extern int qla82xx_abort_target(struct fc_port *, unsigned int, int);
extern int qla82xx_lun_reset(struct fc_port *, unsigned int, int);
...
extern int qla82xx_pci_get_crb_addr_2M(struct qla_hw_data *, u64 *);
extern int qla82xx_wr_32(struct qla_hw_data *, u64, u32);
extern int qla82xx_rd_32(struct qla_hw_data *, u64);
extern int qla82xx_rdmem(struct qla_hw_data *, u64, void *, int);
extern int qla82xx_wrmem(struct qla_hw_data *, u64, void *, int);
extern int qla82xx_load_fw(scsi_qla_host_t *, int);
...
extern void qla82xx_clear_rst_ready(struct qla_hw_data *ha);
extern uint32_t qla82xx_wait_for_state_change(struct qla_hw_data *, uint32_t);
extern int qla82xx_device_state_handler(scsi_qla_host_t *);
extern void qla82xx_dev_failed_handler(scsi_qla_host_t *);
extern void qla82xx_clear_qsnt_ready(struct qla_hw_data *);
...
extern int qla25xx_create_rsp_que(struct qla_hw_data *, uint16_t, uint8_t,
      uint16_t, int);
extern int qla25xx_update_req_que(struct scsi_qla_host *, uint8_t);
