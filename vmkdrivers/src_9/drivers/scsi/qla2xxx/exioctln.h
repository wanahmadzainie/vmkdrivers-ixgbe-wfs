...
#define EXT_CC_RESERVED0P_OS                                            \
    QL_IOCTL_CMD(0x17)
#define EXT_CC_RESERVED0Q_OS						\
    QL_IOCTL_CMD(0x18)
#define EXT_CC_RESERVED0R_OS						\
    QL_IOCTL_CMD(0x19)
#define EXT_CC_RESERVED0S_OS						\
    QL_IOCTL_CMD(0x1A)
#define EXT_CC_RESERVED0T_OS						\
    QL_IOCTL_CMD(0x1B)
#define EXT_CC_RESERVED0U_OS						\
    QL_IOCTL_CMD(0x1C)
#define EXT_CC_RESERVED0V_OS						\
    QL_IOCTL_CMD(0x1D)
#define EXT_CC_RESERVED0W_OS						\
    QL_IOCTL_CMD(0x1E)
#define EXT_CC_RESERVED0X_OS						\
    QL_IOCTL_CMD(0x1F)
