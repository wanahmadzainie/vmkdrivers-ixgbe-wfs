...
#define CNIC_MODULE_VERSION	"1.10.2j.v50.7-3vmw"
#define CNIC_MODULE_RELDATE	"Dec 14, 2011"
...
struct cnic_eth_dev {
	u32		version;
	#define CNIC_ETH_DEV_VER 0x12340001 /* Change this when the structure changes */
